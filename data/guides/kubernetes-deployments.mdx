...
<Figure src="/img/guides/2024/07/kubernetes-deployments-cover.webp" alt="" caption="" />
...
<Figure src="/img/guides/2024/07/deployment.webp" alt="How a Deployment works" caption="How a Deployment works" /><br></br>
...
<Figure src="/img/guides/2024/07/Recreate.webp" alt="Recreate deployment strategy" caption="Recreate deployment strategy" /><br></br>Example:
...
<Figure src="/img/guides/2024/07/rolling-update.webp" alt="Rolling update deployment strategy" caption="Rolling update deployment strategy" /><br></br>Example:
...
<Figure src="/img/guides/2024/07/blue-green.webp" alt="Blue/Green deployment strategy" caption="Blue/Green deployment strategy" /><br></br>Example:
...
<Figure src="/img/guides/2024/07/canary.webp" alt="Canary deployment strategy" caption="Canary deployment strategy" /><br></br>Example:
